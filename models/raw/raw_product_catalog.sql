...
WITH source_data AS (
    SELECT 
        ...
        -- Pricing on various marketplaces
...
marketplace_analysis AS (
    SELECT 
        *,
        -- Analysis of pricing across marketplaces
        ...
        -- Minimum and maximum marketplace prices
        ...
        -- Average price across all marketplaces
        ...
        -- Profit margin percentage for each marketplace
...
SELECT 
    *,
    -- Price variance across marketplaces
    CASE 
    ...
    -- Marketplace with the lowest price
    CASE 
    ...
    -- Product tier based on average price
    CASE 
