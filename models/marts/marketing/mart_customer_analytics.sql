...
WITH customer_base AS (
    SELECT 
        -- Synthetic customer ID for demonstration
        CASE 
...
customer_metrics AS (
    SELECT 
        ...
        -- Simplified favorite product category
...
rfm_analysis AS (
    SELECT 
        *,
        ...
        -- Combined Recency, Frequency, and Monetary score
        CONCAT(
...
customer_segmentation AS (
    SELECT 
        *,
        ...
        -- Current stage in the customer lifecycle
        CASE 
        ...
        -- Customer value category based on revenue
        CASE 
        ...
        -- Customer engagement level based on purchases
        CASE 
        ...
        -- Customer's preferred shopping season
        CASE 
...
predictive_metrics AS (
    SELECT 
        *,
        -- Predicted 2-year Customer Lifetime Value (CLV)
        CASE 
        ...
        -- Predicted time until the next order
        CASE 
