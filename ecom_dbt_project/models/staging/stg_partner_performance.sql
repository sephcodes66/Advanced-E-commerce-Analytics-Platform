...
enriched_data as (
    select 
        *,
        ...
        -- Order processing time (simulated for demo)
        case 
        ...
        -- Partner channel grouping for analysis
        case 
...
where data_quality_flag = 'valid'
  and order_date >= '2021-01-01'  -- Data quality: exclude old/invalid dates