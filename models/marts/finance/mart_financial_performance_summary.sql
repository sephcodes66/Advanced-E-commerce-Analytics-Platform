...
financial_insights as (
    select 
        *,
        -- Daily and monthly growth rates
        case 
        ...
        -- Revenue and margin trend status
        case 
        ...
        -- SKU health and efficiency rates
        case 
