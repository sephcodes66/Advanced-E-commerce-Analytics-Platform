...
WITH source_data AS (
    SELECT 
        -- Unique identifiers for orders and products
        ...
        -- Financial information for the order
        ...
        -- Flags for B2B sales and promotions
...
SELECT 
    *,
    -- Custom business logic and categorizations
    CASE 
    ...
    -- Flag to indicate if the order was placed on a weekend
    CASE 
